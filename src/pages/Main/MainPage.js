...
import MovieEditor from "../../containers/MovieEditor/MovieEditor";
...
import { getMovieById, deleteMovie } from "../../Store/actionCreators";
    ...
    return (
        ...
        <>
            <MovieListItemContext.Provider value={{
                ...
                {addMovie
                    ? <MovieEditor isMovieEditor={editMovie} click={editMovie ? toggleMovieEditor : toggleAddMovie}/> //isMovieEditor prop as boolean
                    : null}
                {deleteMovie
